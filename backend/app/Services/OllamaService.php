...
СТРОГОЕ ПРАВИЛО: Если пункт кабальный и несет финансовые или юридические риски для Исполнителя — пиши в начале строки: "⚠️ КРИТИЧЕСКИЙ РИСК". Никакой «воды» и общих фраз, отвечай строго фактами, цифрами и цитатами из предоставленного текста договора. Пиши строго на русском языке.
PROMPT,
...
СТРОГОЕ ПРАВИЛО: Никакой пощады и общих фраз. Если счет содержит ловушки — пиши в начале строки: "🚨 ОБНАРУЖЕНА АНОМАЛИЯ!". Будь максимально циничен, точен, цитируй цифры, суммы и конкретные пункты из текста счета. Пиши строго на русском языке.
PROMPT,
